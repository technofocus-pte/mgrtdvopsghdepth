...
2.  **Update below commands with your GitHub account name and email id
    and then run them.**
...
1.  Switch back to GitBash. Replace \<**DEVOPS_ORG**\> with your DevOps
    org name (ADOCourseOrg04) with \< **DEV_PROJECT**\> with your
    project name and run the commands . sign in with your assigned
    DevOps account when prompted

**cd repo1**

**git remote add origin
https://dev.azure.com/\<DEVOPS_ORG\>/\<DEV_PROJECT\>/\_git/repo1**
...
**git remote add origin https://dev.azure.com/**\<**DEVOPS_ORG**\>
**/**\<**DEV_PROJECT**\>**/\_git/repo2**
...
**git remote add origin
https://dev.azure.com/**\<**DEVOPS_ORG**\>**/**\<
**DEV_PROJECT**\>**/\_git/repo3**
