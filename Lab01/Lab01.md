...
9.  Enter the name as : **devopstoken** and select the following scopes
    and select **Full access** scopes and click on **Create**.
...
2.  **Replace** you@example.com **with your GitHub account and Your Name
...
12. **Run below command to push local folder to Azure Devops .(Replace**
...
14. **Run below command to push the repo to Devops . if it prompts to
...
15. **Go back to Azure Devops project and check Repos-\> Files .You
...
4.  **Enter the token name -** **githubtoken-test and select all scopes
    .**
...
2.  Replace YOURGITHUBUSERNAME with your username in below command and
    run below command to provide migrator role

gh gei grant-migrator-role --github-org **devopstogtihub** --actor
\<YOURGITHUBUSERNAME\> --actor-type USER
