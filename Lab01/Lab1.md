...
1.  Keep default values in “We need few more details “ page ,select your
...
4.  Keep the default values and then click on **Continue**

5.  Click on the existing project- **dev-github-project-XXXX**

![](./media/image34.png)

6.  In the top right corner of the screen, click **User settings**.
...
8.  Enter the name as : +++**devopstoken+++** and select the following
    scopes and select **Full access** scopes and click on **Create**.

![](./media/image37.png)

9.  Copy the generated API token and save it in a safe location. For
...
+++gh ado2gh migrate-repo --ado-org $ADO_ORG --ado-team-project
$ADO_PROJECT  --ado-repo dev-github-proj --github-org $GEC_ORG
