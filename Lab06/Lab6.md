...
4.  Enter the Repository name as
    +++**tailspin-spacegame-web-deploy+++**. Unselect “**Add a README**”
...
2.  Go to +++**C:\Labfiles\Lab06+++** and select **the** folder
    +++**mslearn-trailspin-spacegame-web-deploy**+++
...
5.  Fill out the required fields as follows: If prompted, sign in to
    ...
    - Service connection name : +++***Resource Manager - Tailspin -
      Space Game+++***
...
4.  Enter +++***Release+++*** for the **variable group name**.
    Select **Add** under **Variables** to add a new variable.

> ![](./media/image145.png)

5.  Enter +++***WebAppName+++*** for the variable name and your App
    Service instance's name for its value: for
    example, +++***tailspin-space-game-web-***.(Webapp name you created
    in previous task-2s)+++.Select **Save**.
